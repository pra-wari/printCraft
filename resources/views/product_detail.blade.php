    ...
    <body>
        ...
        <div class="container">
            <div class="contact-wrap-form">
                <form action="product/detail" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="size" class="form-control" placeholder="height x width in cm" required>
                    </div>
                    <div class="form-group">
